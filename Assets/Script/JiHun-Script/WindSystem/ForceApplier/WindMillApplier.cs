...
public class WindMillApplier : IForceApplier
{
    [SerializeField] private IForceReaction dpIncreaseReaction;
    private bool bWindMillPollution = false;
    public void SetIsPollution(bool bWindMillPollution)
    {
        this.bWindMillPollution = bWindMillPollution;
    }
    public override void Apply(ForceEntity forceEntity)
    {
        ...
        if (hitPlayer && bWindMillPollution)
            this.activeReaction(dpIncreaseReaction, Vector3.zero);
    }
}
